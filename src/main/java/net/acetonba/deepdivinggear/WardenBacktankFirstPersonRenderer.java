...
public class WardenBacktankFirstPersonRenderer<E extends LivingEntity> {

    private static final ResourceLocation BACKTANK_ARMOR_LOCATION =
            DeepDivingGear.asResource("textures/models/armor/warden_diving_arm.png");
    ...
    public static void clientTick() {
        ...
        rendererActive =
                mc.player != null && mc.player.getItemBySlot(EquipmentSlot.CHEST).is(DDGItems.WARDEN_BACKTANK.get());;
    }
